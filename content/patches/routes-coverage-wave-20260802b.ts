...
export const patchRoutes: Route[] = [
  ...
  },
  {
    ...
    fromHome: false,
    themes: ['corridor'],
    daysLabel: '约8–12天（含西宁适应与拉萨休整）',
    transport:
      '北京飞西宁→西宁适应→乘青藏铁路旅客列车（供氧车厢）至拉萨→拉萨慢住→飞回北京（常经成都）。全程非自驾强制；禁止未评估直接硬座过夜或下站高强度活动',
    budgetLabel: '本趟约6000–11000元（机票+软卧/卧铺+供氧住宿；双人）',
    coverImage:
    ...
    summary:
      '适老铁路主题：以列车代步体验青藏线，非公路自驾。须西宁适应与行前体检；拉萨仍高原，下站只慢住。可中止于西宁或格尔木折返。不衔接阿里/珠峰。',
    introduction:
      '青藏铁路是「坐着适应」的进藏方式之一，但仍有高原风险：车厢供氧不等于无高反。爸妈优先软卧，行前体检，西宁先住稳再上车。\n\n到拉萨后至少静养数日，再考虑城区浅逛；布达拉台阶多可外观。身体不适随时在格尔木等站下撤或返程。绝不接阿里/珠峰公路。',
    seasonGuide: '夏秋车次与天气相对稳定。冬春极寒与供暖需额外评估。',
    whyFast: '拉萨城区游览可极简；只完成铁路体验+拉萨静养也成立。',
    notices: [
      '行前必须健康评估；心脑血管等高风险者不宜。',
      '优先软卧；备血氧仪与医生建议下的药物/氧气方案。',
      '非自驾强制；公路 G109 连续驾驶不在本线。',
      '拉萨仍须适应；高反加重立即就医或下撤。不排阿里/珠峰。',
    ],
