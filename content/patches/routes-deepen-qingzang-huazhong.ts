...
export const patchRoutes: Route[] = [
  // ── 青藏 · 日喀则浅尝（须在拉萨适应之后）────────────────────
  {
    ...
    tripType: 'short',
    fromHome: false,
    daysLabel: '约3–4天（接在拉萨适应之后）',
    transport:
      '仅在拉萨已适应至少3–5日、身体稳定后再赴日喀则：拉日高铁约2.5–3小时或包车；日喀则机场可飞返拉萨或经拉萨飞回北京。禁止未适应直接飞日喀则。',
    budgetLabel: '本趟约3500–6500元（含拉日交通与住宿；不含拉萨适应段大交通）',
    coverImage:
      'https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?w=1200',
    summary:
      '拉萨适应完成后的浅尝短延伸（多源约加2–3天）：日喀则约3800米，扎什伦布量力浅访，不排珠峰。不垫五日空转；高反加重立即下撤拉萨，整段可取消。结束后经拉萨飞京再休整。',
    whyFast:
    ...
    stops: [
      {
        ...
        lng: 91.172,
        summary:
          '确认血氧与症状平稳再西行；返程经拉萨歇脚再飞京。适应主段见拉萨慢住卡，本站不重复垫适应周。',
        tips:
      ...
      },
      {
        ...
        lng: 88.87,
        summary:
          '班禅驻锡地。外围与平缓院落浅访；台阶多处可跳过，外观亦可。可与市区浅住同日或隔日。',
        tips:
