...
export const patchRoutes: Route[] = [
  // ── 梵净山（独立；与荔波地理过远）────────────────────────
  {
    ...
    introduction:
      '父母搜「梵净」应对上索道观峰，而不是特种兵爬几千级台阶。本线以山下电梯酒店连住、观光车+索道至核心观景台为主；红云金顶台阶陡、桥窄，膝盖血压不稳默认跳过。\n\n黔东佛教名山与世界自然遗产气质：雾雨多见，备雨衣与薄外套；山区弯道少夜赶。金顶文化符号可外观理解，不必强登窄桥打卡——「到过梵净」不等于「爬完金顶」。\n\n荔波在黔南，车程过长另开专线；勿与黄果树同周硬拼。',
    seasonGuide:
  ...
  // ── 荔波小七孔（独立）────────────────────────────────────
  {
    ...
    introduction:
      '搜「荔波」「小七孔」应直达本卡。以县城电梯酒店连住、观光车串联古桥与水上森林浅走，不排特种兵一日走完全部景点；大七孔/漂流默认可删。\n\n黔南喀斯特水景与茂兰式绿意：栈道湿滑，防滑鞋必带；夏水量大更壮观也更滑。布依/水族文化浅尝即可，勿排满村寨特种兵——父母要的是绿水古桥，不是刷完所有打卡点。\n\n梵净在铜仁方向，地理过远另线；勿与梵净同短假硬赶。',
    seasonGuide:
  ...
  // ── 神农架（独立；恩施山路另卡）──────────────────────────
  {
    ...
    introduction:
      '神农架是鄂西林区避暑名地，但海拔与盘山对爸妈是真实负担——木鱼镇电梯慢住 + 观光车选段（神农顶/大九湖二选一）即可，长线徒步与野生动物近距离项目默认删。\n\n清淡鄂菜少油炸。恩施大峡谷另卡；两地山路相连但车程长，默认分两次出门。不适即下撤宜昌/襄阳。',
    seasonGuide:
  ...
  // ── 恩施大峡谷（独立）────────────────────────────────────
  {
    ...
    introduction:
      '搜「恩施大峡谷」应直达本卡。垂直电梯与观光车减负看峡谷气势，云龙地缝长线可删；恐高者选段外观即可，栈道湿滑穿防滑鞋。\n\n土家菜偏辣，点微辣或免辣，清汤面/蒸蛋保底。神农架另线；山路相连但车程长，默认分趟出门。',
    seasonGuide:
  ...
  // ── 中山（珠三角城市补线）────────────────────────────────
  {
    ...
    introduction:
      '中山填珠三角西岸城市缺口：翠亨孙中山故居是近代史浅读锚点，爸妈以故居展陈与平路公园为主，主题园与夜场默认可删。\n\n粤菜清蒸鱼/白切鸡保底，少油炸甜腻过量。暑热缩短午后；勿与开平丹霞同短假硬拼。',
  ...
  // ── 潮汕加深（脱离广州基地）──────────────────────────────
  {
    ...
    introduction:
      '潮汕是工夫茶与潮菜的名城气质：潮州牌坊街/广济桥平地慢逛为主，汕头小公园骑楼半日可选，南澳船渡默认可删。\n\n牛肉火锅别贪凉；卤味控盐；工夫茶浅尝勿空腹灌浓茶。广州湾区长线里的潮汕支线升格为独立加深卡，不必连赶南澳。',
    seasonGuide:
