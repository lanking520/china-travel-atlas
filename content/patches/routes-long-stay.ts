...
export const patchRoutes: Route[] = [
  ...
  // ── 阳朔（已从长居降级：无本地三甲 → 桂林枢纽短腿）────────
  {
    ...
    summary:
      '【非长居推荐】阳朔山水适合一周内慢短住，不是与昆明同级的月租基地：本地无三甲、镇区物资中等。医疗与大采购下撤桂林；真要约一个月请改昆明/大理。更长漓江节奏见「桂林阳朔·漓江慢住」。',
    introduction:
      '本卡从「长居」降级为山水短腿：喀斯特仍值得来，但站立门槛（本地三甲+物资深度）不过关，不宜与昆明级基地并列「长居推荐」。\n\n节奏：阳朔镇区或稍离西街的电梯民宿连住数日；漓江正规游船一次、遇龙河竹筏短段量力、十里画廊/兴坪电瓶车半日。攀岩、特种兵骑行与夜场不排。雨天改茶馆空白。\n\n枢纽诚实：进出港与就医下撤用桂林（约1–1.5小时）；桂林有三甲与更全商超。想把漓江当两三周主线，走「桂林阳朔·漓江慢住」（桂林歇脚+阳朔慢住）；约一个月空气/医疗优先仍推昆明、大理。',
    seasonGuide:
      '春秋最舒适。夏季湿热与暴雨宜缩短；冬季阴冷潮湿。台风外围偶发，关注预警。',
    notices: [
      '【已降级】非「长居推荐」；本地无三甲→桂林下撤；月租请改昆明/大理。',
      '游船/竹筏选正规票点，备救生衣与防滑鞋。',
      '雨后山路湿滑，日归改室内或茶馆。',
      '桂林两江机场往返预留堵车与接驳时间。',
      '避开西街夜噪带；短住不必先订满月。',
  ...
  // ── 镇远（已从长居降级：无本地三甲+物资薄 → 贵阳枢纽短腿）──
  {
    ...
    summary:
      '【非长居推荐】江城尺度适合数日慢短住，不是昆明级月租基地：本地无三甲、县城物资偏薄。医疗与补给以贵阳为枢纽；真长居改昆明/大理。更紧凑三天见「镇远·舞阳河古城」；贵阳作基地见「贵阳基地·黄果树与黔东可选」。',
    introduction:
      '本卡从「长居」降级为黔东江城短腿：夏凉、沿江平缓仍值得来，但三甲与物资达不到站立门槛，不再与昆明并列「长居推荐」。\n\n节奏：沿江短住数日，舞阳河游船一次、青龙洞外观/平缓段、石板街散步留空白。高坡苗寨特种兵默认不排。比「镇远·舞阳河古城」三天卡略松，仍不是月租。\n\n枢纽诚实：进出与就医下撤用贵阳（高铁便利、本地三甲与商超完整）。想以贵阳为慢住锚再辐射黄果树/黔东，走「贵阳基地」长线；约一个月空气/医疗优先仍推昆明、大理。',
    seasonGuide:
      '春、秋、夏（避暑）可排。冬季阴冷潮湿宜缩短。雨季关注山洪与滑坡预警。',
    notices: [
      '【已降级】非「长居推荐」；本地无三甲+物资薄→贵阳下撤；月租请改昆明/大理。',
      '古城石板湿滑，夜间少赶路。',
      '自驾山区弯道谨慎，优先高铁+当地交通。',
      '民族村寨尊重当地习俗与拍摄规定。',
      '高坡苗寨特种兵不排；问清热水与防潮。',
