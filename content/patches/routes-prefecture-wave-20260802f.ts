...
export const patchRoutes: Route[] = [
  // ── 运城盐湖 / 解州关帝庙 ────────────────────────────────
  {
    ...
    introduction:
      '搜「运城盐湖」「解州关帝庙」应命中本卡。晋南运城以盐池平岸与解州关帝庙院落闻名——关公信仰的重要祖庙之一，父母看的是平院香火与盐湖反光，不是晋南文物特种兵。\n\n盐湖夏日反光强，墨镜防晒；庙内登高台阶可删。运城面食（扯面、羊肉泡）少油清汤吃。与临汾广胜分次出门。',
    seasonGuide:
  ...
  // ── 临汾 · 广胜寺 / 尧都缓冲 ──────────────────────────────
  {
    ...
    introduction:
      '搜「临汾」「广胜寺」「洪洞」应命中本卡。尧都缓冲（博物馆/铁佛寺）+ 洪洞广胜寺选段：飞虹塔与壁画以闻名，但台阶坡道对约60不友好，默认可只下院/外观。\n\n华门/尧庙以平地外观为主。尧都面食清淡少油炸。与运城盐湖分次，勿同日两城。',
    seasonGuide:
  ...
  // ── 潍坊 · 十笏园 / 风筝馆 ────────────────────────────────
  {
    ...
    introduction:
      '搜「潍坊」「十笏园」「风筝博物馆」应命中本卡。鲁中潍坊以「风筝之都」与十笏园私家园林闻名——父母走平缓园林 + 室内风筝馆即可，不是风筝会人潮特种兵。\n\n填青岛/烟台之间高铁缺口。鲁菜清淡选：朝天锅浅尝、清汤面与时蔬保底。风筝节高峰改馆线；与崂山分次。',
    seasonGuide:
  ...
  // ── 荆州古城 ────────────────────────────────────────────
  {
    ...
    introduction:
      '搜「荆州古城」「荆州博物馆」应命中本卡。荆州是楚文化与三国叙事交汇的古城——父母以博物馆（含楚文物展陈）+ 东门一带城墙选段为主，不是环城硬走特种兵。\n\n鱼鲜清蒸、热干面/豆皮少油；完整环城与登城台阶默认可删。与武汉/宜昌/三峡分次出门。',
    seasonGuide:
  ...
  // ── 宣城 / 泾县（与黄山分周）────────────────────────────
  {
    ...
    introduction:
      '搜「宣城」「泾县」「查济」「桃花潭」应命中本卡，而不是再被黄山索道清单淹没。皖南宣纸/泾县文房与查济古村石板巷，是黄山之外的县域慢住气质。\n\n查济选一两段慢走；桃花潭游船晕动可删；广教寺双塔外观为主。皖南菜少油，粥面保底。黄山峰顶另周。',
    seasonGuide:
