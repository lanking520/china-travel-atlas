...
export const routes: Route[] = [
  // ── 华北 · 北京出发短途 ──────────────────────────────────────────
  {
    ...
    summary:
      '坡度较缓、人流少于八达岭，适合父母慢慢登城。建议早出发，坐摆渡车进北检票口，厢式缆车到14号敌楼后只走一小段，午后返京。',
    researchKeywords: ['慕田峪 老人 缆车', '慕田峪 自驾 停车', '慕田峪 银杏'],
    sources: [
      {
        title: '慕田峪长城景区官网须知',
    ...
    stops: [
      {
        ...
        tips:
          '一定先坐摆渡车（停车场到登城口约3公里）。优先厢式缆车双程；索道/滑道刺激，高龄或不适高空慎选。北京户籍60岁以上门票政策更优惠，缆车另计。山上厕所少，入口先解决。',
        image:
  ...
  },
  {
    ...
    stops: [
      ...
      },
      {
        ...
        tips:
          '天津站出站即近海河，与意风区、津门故里可一路步行，无需赶景点。游船可选（约100元），但步行已够看景。傍晚光线好、气温凉，适合老人；想乘摩天轮须预约，风大可能停运。21:00前后返北京南，12306可设敬老版或窗口购票。',
        image:
    ...
    stops: [
      {
        ...
        tips:
          '早7:30–8:30入园，先宫殿后湖区。山区一定买环山车（约50–60元，5–10月运营），别硬爬；11月至4月山区常关闭。湖区轮椅可通行，长廊多可歇脚。北京/天津户籍60+免门票（须身份证），观光车另有优惠。公众号「避暑山庄及周围寺庙」可预约。',
        image:
      ...
      },
      {
        ...
        tips:
          '与山庄分开购票，成人约60元；60–69半价、70+免票（以当日公示为准）。从山庄出来别硬接，回酒店午休后再去。主殿前台阶可慢上，不必赶讲解全程。秋季层林尽染，摄影佳；夏季带遮阳帽和水。',
      },
    ],
  },
  {
    ...
    stops: [
      {
        ...
        lng: 117.278,
        summary:
          '汤市街、日月岛沿水慢走，灯光秀与温泉可选。主街平路，游客中心可租轮椅。',
        tips:
          '散客门票约140元，60+优惠（须身份证）。主街无大坡，累了坐电瓶车（购票）；部分桥梁和码头有小台阶，轮椅绕行。建议住景区内，中午回房休息；夜间比市区低5℃，带外套。水边石板冬春季防滑；停车场小车约25元/次。',
        image:
  ...
  // ── 华北 · 长线慢游 ──────────────────────────────────────────
  {
    ...
    summary:
      '以大同古城为慢游大本营，每天一处古建，每周留2–3个空白日。云冈细品、悬空寺远观、应县木塔外围瞻仰；体力好可南延平遥。三周后自驾回京休整。',
    whyFast: '悬空寺与恒山合并一日快览，山下看即可；登临限流且台阶险，节省体力给云冈。',
    researchKeywords: [
      '云冈石窟 老人 预约',
      '悬空寺 观景台 不登临',
      '大同 自驾 回京 G6',
    ...
    stops: [
      ...
      },
      {
        ...
        lng: 113.712,
        summary:
          '一日往返浑源。山下观景台可拍全貌；登临台阶陡窄且每日限流，老人宜远观。',
        tips:
      ...
      },
      {
        ...
        tips:
          '外来车须停城外停车场，再步行或电瓶车进城。选无台阶客栈，提前确认位置。日升昌等票号有门槛台阶，看外观也可。平遥牛肉、油茶口味清淡。3日慢住后返大同或直接 G6 回京。',
      },
    ],
  },
  ...
  // ── 西南 · 云南长线 ──────────────────────────────────────────
  {
    ...
    coverImage:
      'https://images.unsplash.com/photo-1547981609-4c991a471551?w=1200',
    summary:
      '飞昆明中转后直奔大理，洱海边慢住三四周——环海选段包车、每天最多一两个点，每周留空白日。体力好时用1–2日快览丽江（老人优先云杉坪+蓝月谷，慎上大索道）。结束后飞回北京休整。',
    ...
    stops: [
      ...
      },
      {
        ...
        tips:
          '洱海生态廊道全程平坦，走累了随时有休息椅，也可坐共享电瓶车。环海建议包车（约200–300元/天），司机送到景点门口。选有电梯、近大理市第一人民医院的客栈。三月樱花、十一月红树；紫外线强，避开正午暴晒。龙龛码头发呆、地热国泡温泉都是不错的休息日选择。',
        image:
          'https://images.unsplash.com/photo-1547981609-4c991a471551?w=800',
      },
      {
      ...
      },
      {
        ...
        lng: 100.229,
        summary:
          '老人优先云杉坪小索道（3240米）+ 蓝月谷（2950米），栈道平缓。大索道4506米仅适合无基础病且已在丽江适应1–2日者。',
        tips:
          '索道票在「丽江旅游集团」小程序预约：大索道20:00放次日票，云杉坪21:00放票。60–69门票半价、70+免票。到大理后至少过一周再去丽江，别刚到就上山。备氧气与厚外套；感到气短立即停下吸氧。基础病或70+行动不便者只逛蓝月谷即可。',
        image:
          'https://images.unsplash.com/photo-1508804185872-d83badb8660a?w=800',
      },
    ],
  ...
  // ── 西北 · 丝路长线 ──────────────────────────────────────────
  {
    ...
    stops: [
      ...
      },
      {
        ...
        tips:
          '唯一官方预约：「莫高窟参观预约网」微信小程序或 www.mgk.org.cn，可约30天内门票。须在所约时段前30分钟到数字展示中心。60–69岁优惠票、70+特优票均须提前网上预订后窗口取票。高龄老人须亲友陪同，景区有爱心窗口和绿色通道。咨询电话4008-333-715（仅咨询，不支持电话预约）。',
      },
      {
        id: 'jiayuguan',
        name: '嘉峪关',
        ...
        tips:
          '从敦煌自驾约4–5小时，中途服务区多休息。关城景区平坦，悬壁长城台阶多，老人可远观即走。在此住一晚，第二天从容前往张掖。',
      },
      {
        id: 'zhangye-danxia',
        name: '张掖七彩丹霞',
  ...
  // ── 东北 · 夏季 ──────────────────────────────────────────────
  {
    ...
    summary:
      '夏季天池可见概率高，温度凉爽。北坡开发成熟，全程环保大巴串联景点，登顶天池可乘倒站车，老人少走路。',
    ...
    stops: [
      ...
      },
      {
        ...
        tips:
          '北坡设施最全，适合带老人：全程大巴循环，不必长距离徒步。天池因天气常临时关闭，关闭时仍可看瀑布与地下森林，勿白跑一趟失望。建议赶早批入园，13:30前停止检票。',
        image:
          'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=800',
      },
      {
  ...
  // ── 华东 · 春秋 ──────────────────────────────────────────────
  {
    ...
    summary:
      '西湖有无障碍旅游专线，电瓶车+无障碍游船衔接景点；苏州园林平地为主。适合春秋慢慢走，不赶全程。',
    researchKeywords: [
      '杭州西湖 无障碍 环湖',
      '西湖 无障碍游船',
      '苏州园林 少走路 老人',
    ...
    stops: [
      {
        ...
        lng: 120.15,
        summary:
          '可走北山街—断桥—白堤等平整路段；也可乘「西湖无障碍旅游专线」，无障碍游船+电瓶车串联三潭印月、花港观鱼等。',
        tips:
          '部分山体与古建受保护无法完全无障碍，可咨询现场移动坡道。雷峰塔有电梯。春季避开清明高峰；秋季桂花飘香。推轮椅或腿脚慢者优先选无障碍专线，不必硬走苏堤全程。',
        image:
      ...
      },
      {
        ...
        tips: '拙政园台阶不多但需久站，可带折叠凳。上午人少光线好；下午平江路找茶馆歇脚。',
      },
      {
        id: 'tongli-optional',
        name: '同里古镇（可选）',
        ...
        tips: '古镇石板路，穿防滑软底鞋；不必逛全，选一条水巷慢慢走即可。',
      },
    ],
  },
  ...
  // ── 华南 · 冬季避寒 ──────────────────────────────────────────
  {
    ...
    stops: [
      ...
      },
      {
        ...
        tips:
          '从厦门包车或报团约2.5小时，山路多弯，老人易晕车，备晕车药。土楼内台阶和鹅卵石路多，穿防滑鞋。若体力有限，只去田螺坑一处即可，不必连看洪坑、云水谣。',
      },
    ],
  },
    ...
    stops: [
      {
        ...
        tips:
          '进藏前做心肺体检，感冒期间禁止进藏。初到3天勿洗热水澡、勿跑跳，动作慢、多饮水。遵医嘱备红景天（出发前一周起）和便携氧气。选供氧酒店，随身带血氧仪；血氧低于90%或症状加重立即吸氧。每日游览不超过5小时，中间必回酒店休息。附近有西藏自治区人民医院和拉萨市人民医院。',
      },
      {
        id: 'potala',
        name: '布达拉宫',
        ...
        tips:
          '微信搜「布达拉宫票务预订系统」小程序，旺季提前10天预约。60+「运用智能技术困难」者可提前一天到门票预订处「老年人专用窗口」现场预约（9:00起，数量有限）。同一微信号可绑2名老人。参观当天提前1小时到正门安检口。台阶多，累了就歇；走不动可在雪城外观，不必硬撑上楼。景区未授权任何第三方代售，谨防受骗。',
        image:
      ...
      },
      {
        ...
        tips:
          '须在拉萨适应至少3–5日后再去，心脏病/高血压/慢阻肺老人不建议前往。建议包车或正规一日游（含氧气与保险），单程约4小时。湖边风大，即便夏季也备羽绒服。感到持续呕吐、呼吸困难立即吸氧并下撤；途中无大型医疗设施。若父母高反明显，宁可改去羊卓雍措（海拔较低），别勉强。',
      },
    ],
  },
  ...
  // ── 东北 · 冬季看雪 ──────────────────────────────────────────
  {
    ...
    coverImage:
      'https://images.unsplash.com/photo-1518105770772-7edf0af8b036?w=1200',
    summary:
      '冬季北国看雪经典短途：冰雪大世界夜景、中央大街漫步。65岁以上可预约免费观光票，园内商服暖房随时歇脚。',
    whyFast: '冰雪大世界一日为主角，分段逛、多进暖房；索菲亚教堂与松花江可合并半日平地游。',
    researchKeywords: [
      '哈尔滨冰雪大世界 老人 免费',
      '冰雪大世界 暖房 休息',
      '哈尔滨 中央大街 冬季 适老',
    ...
    stops: [
      {
        ...
        tips:
          '落地后前3天以静养为主，别一上来就暴晒暴走——南北温差大，高血压老人尤须防血压波动。备薄外套，强冷空气时最低可至11–15℃。选正规老年公寓/酒店，关注卫健备案。',
        image:
          'https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?w=800',
      },
      {
  ...
  // ── 西南 · 成都慢住 ──────────────────────────────────────────
  {
    ...
    stops: [
      ...
      },
      {
        ...
        tips:
          '走左手无障碍通道，坡道平缓。不必刷完全部场馆，看够即回。下午2点后人少，也可选此时段。',
      },
      {
