 ...
 * Intentionally avoids `@/content` index (route-details / practical guides).
 * Home / ChinaMapExplorer / route-search must import from here.
 */
...
export const catalogRoutes: Route[] = collectRawRoutes().map((route) =>
